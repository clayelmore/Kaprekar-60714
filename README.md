...
| | |
|---|---|
| **[paper.pdf](paper.pdf)** | The complete paper, compiled (76 pages, ~720 KB). The canonical reading version. Includes Appendix F (added April 29, 2026; §F.5 revised April 30, 2026): preliminary working notes on a strengthened *strict-d* criterion. |
...
| F | [Strict-d anchors and the {7,6,4,1}-thread tower](sections/F_strict_d_anchors.md) | Preliminary working notes (April 29, 2026; §F.5 revised April 30, 2026): strict-d criterion, the 11-fp d=7 strict-anchor list, 6174 reappearance at d=7 |
