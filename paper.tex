...
escape class at $d = 3, 4$: a set of inputs that map to $0$ in one
or more applications of the rule, with the inputs characterized by an
algebraic block-alignment condition (single-block repdigits at
$d = 3$, single-block multiples of $1111$ at $d = 4$, multi-block
aligned multisets at $d \geq 7$). See §7.6 for the full continuity
argument. Universal convergence on $A_d \setminus E_d$ is a
