...
\section{2. Rules, coefficients, and the universality criterion}\label{rules-coefficients-and-the-universality-criterion}
...
\section{3. The spectrum at small lengths}\label{the-spectrum-at-small-lengths}
...
\section{\texorpdfstring{4. Lifting by zeros: \(60714\) at every length}{4. Lifting by zeros: 60714 at every length}}\label{lifting-by-zeros-60714-at-every-length}
...
\section{5. Lifting by duplication: folding}\label{lifting-by-duplication-folding}
...
\section{6. When folding preserves universality}\label{when-folding-preserves-universality}
...
\section{7. The cost of a certificate}\label{the-cost-of-a-certificate}
...
\section{8. Methods and provenance}\label{methods-and-provenance}
...
\section{\texorpdfstring{Appendix A. The thirty-three universal full-variable fixed points at \(d = 5\)}{Appendix A. The thirty-three universal full-variable fixed points at d = 5}}\label{appendix-a.-the-thirty-three-universal-full-variable-fixed-points-at-d-5}
...
\section{Appendix B. The degree-4 Farkas certificate}\label{appendix-b.-the-degree-4-farkas-certificate}
...
\section{\texorpdfstring{Appendix C. The pair-symmetric universal rules at \(m = 2\)}{Appendix C. The pair-symmetric universal rules at m = 2}}\label{appendix-c.-the-pair-symmetric-universal-rules-at-m-2}
...
\section{Appendix D. Rules used in Section 6}\label{appendix-d.-rules-used-in-section-6}
