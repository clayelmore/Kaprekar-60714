[← Back to paper](../README.md#table-of-contents) · [← Previous: Appendix A. Classification tables](A_classification_tables.md) · [Next: Appendix C. Support lemmas →](C_support_lemmas.md)
